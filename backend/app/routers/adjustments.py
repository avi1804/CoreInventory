...
from app.services import adjustment_service, auth_service
...
def add_adjustment(
    ...
    """Add stock adjustment - requires authentication"""
    try:
...
def get_adjustments(
    ...
    """Get all adjustments - requires authentication"""
...
def get_adjustments_by_product(
    product_id: int,
    skip: int = 0,
    limit: int = 100,
    db: Session = Depends(get_db),
    ...
    """Get adjustments by product - requires authentication"""
...
def get_adjustments_by_warehouse(
    warehouse_id: int,
    skip: int = 0,
    limit: int = 100,
    db: Session = Depends(get_db),
    ...
    """Get adjustments by warehouse - requires authentication"""
